...
public class BroadcastStateSample {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        DataStream<Tuple2<String, Integer>> employees = env.readTextFile("/Users/jonasgama/Documents/repos/apache-flink/broadcast.txt")
    ...
    public static class ExcludeEmp extends KeyedBroadcastProcessFunction<String,Tuple2<String, String>, String, Tuple2<String, Integer>>
    {
        ...
        public void processElement(Tuple2<String, String> value, ReadOnlyContext ctx, Collector<Tuple2<String, Integer>> out)throws Exception
        {
            ...
            countState.update(currentCount+1);       // dept    , current sum
            out.collect(new Tuple2<String, Integer>(value.f0, currentCount+1));
        }
